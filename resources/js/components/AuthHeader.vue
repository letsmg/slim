<template>
    <header class="bg-gray-900 shadow-lg border-b border-gray-700">
        <nav class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <!-- Layout: linha única em xl+, duas linhas entre sm e xl, hamburguer abaixo de sm -->
            <div class="xl:flex xl:justify-between xl:h-16">
                <!-- Linha superior: Logo + Usuário + Sair (sempre visível em sm+) -->
                <div class="flex justify-between items-center h-16 xl:h-16">
                    <!-- Logo -->
                    ...
                    <!-- Usuário + Sair (Desktop) - visível em sm+ -->
                ...
                <!-- Linha inferior: Itens do menu (sm até xl) + Dropdown Adm -->
                <div class="hidden sm:flex sm:flex-wrap sm:items-center sm:pb-2 xl:pb-0 xl:flex-nowrap xl:items-center xl:space-x-1">
                    <router-link
                        v-for="item in mainMenuItems"
                        :key="item.path"
                        :to="item.path"
                        class="inline-flex items-center px-2.5 py-1.5 text-xs lg:text-sm font-medium rounded-md transition-colors whitespace-nowrap"
                    ...
                    <div class="relative inline-flex" @mouseenter="admOpen = true" @mouseleave="admOpen = false">
                        ...
                        >
                            ...
                            Adm
                            <svg class="w-3 h-3 lg:w-4 lg:h-4 ml-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                            </svg>
                        </button>
                        <div
                            v-show="admOpen"
                            class="absolute left-0 mt-1 w-48 bg-gray-800 rounded-lg shadow-xl border border-gray-700 py-1 z-50"
                        >
                            <router-link
